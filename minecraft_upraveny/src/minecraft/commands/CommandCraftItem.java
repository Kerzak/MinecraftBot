 ...
 * @author Kerzak
 */
public class CommandCraftItem implements Command {
    ...
    public CommandCraftItem(Crafting crafting, Id id, ChatHandler chat, InventoryManager inventoryManager) {
    ...
    public void execute() {
        ...
        //get stack of items that we have to craft to finsh the task
